...
let num: number = 10;
let result: string = num > 5 ? "num is greater than 5" : "num is less than 5";
console.log(result);

// Now seeing the Example no 02.
let num1: number = 100;
let result1: string = num1 > 50 ? "num is greater than 50" : "num is less than 50";
console.log(result1);

// Now seeing the Example no 03.
let person: string = "Rehan";
let result2: string = person === "Rehan" ? "person is Rehan" : "person is not Rehan";
console.log(result2);

// Now seeing the Example no 04.
let statement: boolean = true;
let result3: string = statement === true ? "statement is true" : "statement is false";
console.log(result3);

// Now seeing the Example no 05.
// The usage of ternary operators in a function.
function getResult(num: number): string | number{
...
let result4: string = "Rehan";
let result5: string = result4 === "Rehan" ? "person is Rehan" : "person is not Rehan";
console.log(result5);
...
let isHungry1: boolean = false;
let snack1: string = isHungry1 ? "apple" : "water";
console.log(`you should have some ${snack1}`);

// Now seeing the Example no 08.
let userName: string = "Rabail khan";
let password: string = "19995";
...
let age = 22;
let message = age >= 18 ? "You're an adult eligible to vote" : "You're a minor not eligibile to vote";
console.log(message);
